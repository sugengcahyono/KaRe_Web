              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>1</td>
                    <td>Citra Insani</td>
                    <td>Kunjungan Untuk Melakukan Wawancara</td>
                    <td>
                        <a  class="btn btn-lihat"><i class="bi bi-eye-fill"></i>   Lihat</a>
                        <a  class="btn btn-edit"><i class="bi bi-pencil-fill"></i>   Edit</a>
                        <button type="button" class="btn btn-tolak" > <i class="bi bi-trash-fill"></i>   Hapus</button>
                    </td>
                    <!-- <td>2012/03/03</td> -->
                    <!-- <td>31%</td> -->
                  </tr>
