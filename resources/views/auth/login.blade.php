  ...
  <main class="main-content  mt-0">
    <section>
              ...
              <div class="card card-plain">
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    Belum punya akun?
                    <a href="javascript:;" class="text-primary font-weight-bold">Daftar</a>
                  </p>
                </div>
              </div>
            </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-6">
          <input id="email" type="text" class="form-contol @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplate="username" autofocus>
          @error('email')
